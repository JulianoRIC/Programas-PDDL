...
(:action GOC1C2 
 :parameters (?s1 ?s2 - side ?c - can1 ?c2 - can2 ?b - boat)
 :precondition(and(at-emb ?s1)(atC1 ?c ?s1)(atC2 ?c2 ?s1))
 :effect(and(at-emb ?s2)(not(at-emb ?s1))(atC1 ?c ?s2)(atC2 ?c2 ?s2)(empty ?b))
)
...
(:action GOM1C2 
 :parameters (?s1 ?s2 - side ?m - mis1 ?c2 - can2 ?b - boat)
 :precondition(and(at-emb ?s1)(atM1 ?m ?s1)(atC2 ?c2 ?s1))
 :effect(and(at-emb ?s2)(not(at-emb ?s1))(atM1 ?m ?s2)(atC2 ?c2 ?s2)(empty ?b))
)

(:action GOM1C3 
 :parameters (?s1 ?s2 - side ?m - mis1 ?c3 - can3 ?b - boat)
 :precondition(and(at-emb ?s1)(atM1 ?m ?s1)(atC3 ?c3 ?s1))
 :effect(and(at-emb ?s2)(not(at-emb ?s1))(atM1 ?m ?s2)(atC3 ?c3 ?s2)(empty ?b))
)
...
(:action GOM2C1
 :parameters (?s1 ?s2 - side ?m2 - mis2 ?c - can1 ?b - boat)
 :precondition(and(at-emb ?s1)(atM2 ?m2 ?s1)(atC1 ?c ?s1))
 :effect(and(at-emb ?s2)(not(at-emb ?s1))(atM2 ?m2 ?s2)(atC1 ?c ?s2)(empty ?b))
)

(:action GOM2C3 
 :parameters (?s1 ?s2 - side ?m2 - mis2 ?c3 - can3 ?b - boat)
 :precondition(and(at-emb ?s1)(atM2 ?m2 ?s1)(atC3 ?c3 ?s1))
 :effect(and(at-emb ?s2)(not(at-emb ?s1))(atM2 ?m2 ?s2)(atC3 ?c3 ?s2)(empty ?b))
)
...
(:action GOM3C3 
 :parameters (?s1 ?s2 - side ?m3 - mis3 ?c3 - can3 ?b - boat)
 :precondition(and(at-emb ?s1)(atM3 ?m3 ?s1)(atC3 ?c3 ?s1))
 :effect(and(at-emb ?s2)(not(at-emb ?s1))(atM3 ?m3 ?s2)(atC3 ?c3 ?s2)(empty ?b))
)


(:action GOM3C1
 :parameters (?s1 ?s2 - side ?m3 - mis3 ?c - can1 ?b - boat)
 :precondition(and(at-emb ?s1)(atM3 ?m3 ?s1)(atC1 ?c ?s1))
 :effect(and(at-emb ?s2)(not(at-emb ?s1))(atM3 ?m3 ?s2)(atC1 ?c ?s2)(empty ?b))
)

(:action GOM3C2
 :parameters (?s1 ?s2 - side ?m3 - mis3 ?c2 - can2 ?b - boat)
 :precondition(and(at-emb ?s1)(atM3 ?m3 ?s1)(atC2 ?c2 ?s1))
 :effect(and(at-emb ?s2)(not(at-emb ?s1))(atM3 ?m3 ?s2)(atC2 ?c2 ?s2)(empty ?b))
)
