(define (domain mec)
    ...
    :precondition(and(free ?b) (at-boat ?m) (atC ?c ?m) (or (>(numberM ?m1)(numberC ?m1)) (>(numberM ?m2)(numberC ?m2))))
    ...
    :precondition(and(free ?b) (at-boat ?m) (atM ?mi ?m) (or (>(numberM ?m1)(numberC ?m1)) (>(numberM ?m2)(numberC ?m2))))
