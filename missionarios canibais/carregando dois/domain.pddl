...
(:action embark
 :parameters(?p - passenger ?p2 - passenger  ?s - side ?b - boat)
 :precondition(and(at ?p ?s) (at ?p2 ?s) (at-emb ?s) (empty ?b))
 :effect(and(carry ?p ?b)(carry ?p2 ?b) (not(at ?p ?s)) (not(at ?p2 ?s)) (not(empty ?b)))
)
